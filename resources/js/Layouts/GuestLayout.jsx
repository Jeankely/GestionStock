...
export default function GuestLayout({ children }) {
    ...
    return (
        <div className="flex min-h-screen flex-col bg-slate-50 text-slate-800 dark:bg-slate-950 dark:text-slate-100">
            <header className="sticky top-0 z-50 border-b border-slate-200/70 bg-white/90 shadow-sm backdrop-blur-md dark:border-slate-800 dark:bg-slate-950/85">
                    ...
                    <div className="flex h-20 items-center justify-between">
                        ...
                        >
                            ...
                            <div className="leading-tight">
                                <div className="flex items-center gap-2">
                                    <h1 className="text-2xl font-extrabold tracking-wide text-black drop-shadow-lg dark:text-white sm:text-4xl">
                                        JK TechStore
                                    </h1>
                                ...
                                <p className="text-xs text-slate-500 dark:text-slate-400 sm:text-sm">
                                    La performance au coeur en matériel
                                    informatique
                                </p>
                            </div>
                        </Link>
                        ...
                        <div className="hidden items-center gap-3 md:flex">
                            ...
                            <Link
                                ...
                                className="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-cyan-600 to-blue-600 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-cyan-500/20 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl"
                            >
                    ...
                    {mobileMenuOpen && (
                        <div className="pb-4 md:hidden">
                            <div className="mt-2 space-y-2 rounded-2xl border border-slate-200 bg-white p-3 shadow-lg dark:border-slate-800 dark:bg-slate-900">
                                ...
                                <Link
                                    href={authButton.href}
                                    className="flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-cyan-600 to-blue-600 px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-cyan-500/20 transition hover:opacity-95"
